...
JobCopilot 是一个离线优先的 Android 求职记录 App，用于管理公司、岗位、投递状态、流程进展、面试复盘、简历版本、备注、表格导入和本地备份。项目源码仓库公开，应用默认只在本机保存数据。
...
```text
dist/jobcopilot-v1.1-debug.apk
```
...
```text
SHA-256: 8F666AE37EEE6DDBAB66863F5EACE2C699A1825EB78400075E948E8AD3FAE206
```
